...
function _uglify_es(e) {
        ...
        function e(e, o, a) {
            ...
            function c() {
                ...
                if (c instanceof t)
                    ...
                    if (c instanceof i)
                        u.push.apply(u, a ? c.v.slice().reverse() : c.v);
                    else
                        u.push(c);
                return l
            }
    ...
    function _(e, n) {
        ...
        return function e(t) {
            ...
            return function(e, t) {
                ...
                if (r < e.length)
                    i.push.apply(i, e.slice(r));
                if (o < t.length)
                    i.push.apply(i, t.slice(o));
                return i
            }(r = e(r), o = e(o))
        }(e)
    }
    ...
    function E(e) {
        ...
        for (var t, i = 0; t = e.parent(i); i++) {
            if (t instanceof x && t.body === n)
                return !0;
            if (t instanceof Ce && t.expressions[0] === n || "Call" == t.TYPE && t.expression === n || t instanceof Be && t.expression === n || t instanceof Se && t.expression === n || t instanceof qe && t.condition === n || t instanceof Me && t.left === n || t instanceof $e && t.expression === n)
                n = t;
            else
                return !1
        }
    ...
    function A(n, t, i, r) {
        ...
        var u = r && new r;
        if (u && u.initialize || i && i.initialize)
            a += "this.initialize();";
        var f = Function(a += "}}")();
        if (u) {
            f.prototype = u;
    ...
    var F = A("Token", "type value line col pos endline endcol endpos nlb comments_before comments_after file raw", {}, null);
    var w = A("Node", "start end", {
        _clone: function(e) {
            if (e) {
                var n = this.clone();
                return n.transform(new mt(function(e) {
                    if (e !== n)
                        return e.clone(!0)
                }
                ))
    ...
    w.warn = function(e, n) {
        if (w.warn_function)
            w.warn_function(v(e, n))
    }
    ;
    var x = A("Statement", null, {
        $documentation: "Base class of all statements"
    });
    var C = A("Debugger", null, {
        $documentation: "Represents a debugger statement"
    }, x);
    var k = A("Directive", "value quote", {
    ...
    var O = A("BlockStatement", null, {
        $documentation: "A block statement"
    }, T);
    var $ = A("EmptyStatement", null, {
        $documentation: "The empty statement (empty block or simply a semicolon)"
    }, x);
    var M = A("StatementWithBody", "body", {
        $documentation: "Base class for all statements that contain one nested body: `For`, `ForIn`, `Do`, `While`, `With`",
        $propdoc: {
            body: "[AST_Statement] the body; this should always be present, even if it's an AST_EmptyStatement"
        }
    }, x);
    var q = A("LabeledStatement", "label", {
    ...
    var z = A("IterationStatement", null, {
        $documentation: "Internal class.  All loops inherit from it."
    }, M);
    var j = A("DWLoop", "condition", {
    ...
    var I = A("For", "init condition step", {
    ...
    var L = A("Scope", "variables functions uses_with uses_eval parent_scope enclosed cname", {
        ...
        clone: function(e) {
            var n = this._clone(e);
            if (this.variables)
                n.variables = this.variables.clone();
            if (this.functions)
                n.functions = this.functions.clone();
            if (this.enclosed)
                n.enclosed = this.enclosed.slice();
            return n
        }
    }, T);
    var V = A("Toplevel", "globals", {
        ...
        wrap_commonjs: function(e) {
            var n = this.body;
            var t = "(function(exports){'$ORIG';})(typeof " + e + "=='undefined'?(" + e + "={}):" + e + ");";
            return (t = vt(t)).transform(new mt(function(e) {
                if (e instanceof k && "$ORIG" == e.value)
                    return d.splice(n)
            }
            ))
        }
    ...
    var J = A("Lambda", "name argnames uses_arguments is_generator async", {
    ...
    var W = A("Accessor", null, {
        $documentation: "A setter/getter function.  The `name` property is always null."
    }, J);
    var X = A("Function", "inlined", {
        $documentation: "A function expression"
    }, J);
    var G = A("Arrow", "inlined", {
        $documentation: "An ES6 Arrow function ((a) => b)"
    }, J);
    var Z = A("Defun", "inlined", {
    ...
    var re = A("Return", null, {
        $documentation: "A `return` statement"
    }, ie);
    var oe = A("Throw", null, {
        $documentation: "A `throw` statement"
    }, ie);
    var ae = A("LoopControl", "label", {
    ...
    var ue = A("Continue", null, {
        $documentation: "A `continue` statement"
    }, ae);
    var fe = A("If", "condition alternative", {
    ...
    var le = A("SwitchBranch", null, {
        $documentation: "Base class for `switch` branches"
    }, T);
    var pe = A("Default", null, {
        $documentation: "A `default` switch branch"
    }, le);
    var de = A("Case", "expression", {
    ...
    var me = A("Finally", null, {
        $documentation: "A `finally` node; only makes sense as part of a `try` statement"
    }, T);
    var _e = A("Definitions", "definitions", {
    ...
    var Ae = A("Export", "exported_definition exported_value is_default exported_names module_name", {
    ...
    var Oe = A("UnaryPrefix", null, {
        $documentation: "Unary prefix expression, i.e. `typeof i` or `++i`"
    }, Te);
    var $e = A("UnaryPostfix", null, {
    ...
    var ze = A("Assign", null, {
        $documentation: "An assignment expression — `a = b + 5`"
    }, Me);
    var je = A("DefaultAssign", null, {
    ...
    var Ie = A("ObjectProperty", "key value", {
        ...
        _walk: function(e) {
            return e._visit(this, function() {
                if (this.key instanceof w)
                    this.key._walk(e);
                this.value._walk(e)
            })
        }
    });
    var Re = A("ObjectKeyVal", "quote", {
        $documentation: "A key: value object property",
        $propdoc: {
            quote: "[string] the original quote character"
        }
    }, Ie);
    var Ue = A("ObjectSetter", "quote static", {
        $propdoc: {
    ...
    var Pe = A("ObjectGetter", "quote static", {
        $propdoc: {
            quote: "[string|undefined] the original quote character, if any",
    ...
    var Le = A("ConciseMethod", "quote static is_generator async", {
        $propdoc: {
            quote: "[string|undefined] the original quote character, if any",
    ...
    var Ve = A("Class", "name extends properties inlined", {
        $propdoc: {
    ...
    var Ye = A("DefClass", null, {
        $documentation: "A class definition"
    }, Ve);
    var Je = A("ClassExpression", null, {
    ...
    var Ge = A("SymbolDeclaration", "init", {
        $documentation: "A declaration symbol (symbol in var/const, function name or argument, symbol in catch)"
    }, We);
    var Ze = A("SymbolVar", null, {
        $documentation: "Symbol defining a variable"
    }, Ge);
    var Ke = A("SymbolBlockDeclaration", null, {
        $documentation: "Base class for block-scoped declaration symbols"
    }, Ge);
    var Qe = A("SymbolConst", null, {
        $documentation: "A constant declaration"
    }, Ke);
    var en = A("SymbolLet", null, {
        $documentation: "A block-scoped `let` declaration"
    }, Ke);
    var nn = A("SymbolFunarg", null, {
        $documentation: "Symbol naming a function argument"
    }, Ze);
    var tn = A("SymbolDefun", null, {
        $documentation: "Symbol defining a function"
    }, Ge);
    var rn = A("SymbolMethod", null, {
        $documentation: "Symbol in an object defining a method"
    }, We);
    var on = A("SymbolLambda", null, {
        $documentation: "Symbol naming a function expression"
    }, Ge);
    var an = A("SymbolDefClass", null, {
        $documentation: "Symbol naming a class's name in a class declaration. Lexically scoped to its containing scope, and accessible within the class."
    }, Ke);
    var sn = A("SymbolClass", null, {
        $documentation: "Symbol naming a class's name. Lexically scoped to the class."
    }, Ge);
    var un = A("SymbolCatch", null, {
        $documentation: "Symbol naming the exception in catch"
    }, Ke);
    var fn = A("SymbolImport", null, {
        $documentation: "Symbol referring to an imported name"
    }, Ke);
    var cn = A("SymbolImportForeign", null, {
        $documentation: "A symbol imported from a module, but it is defined in the other module, and its real name is irrelevant for this module's purposes"
    }, We);
    var ln = A("Label", "references", {
    ...
    var pn = A("SymbolRef", null, {
        $documentation: "Reference to some symbol (not definition/declaration)"
    }, We);
    var dn = A("SymbolExport", null, {
        $documentation: "Symbol referring to a name to export"
    }, pn);
    var hn = A("SymbolExportForeign", null, {
        $documentation: "A symbol exported from this module, but it is used in the other module, and its real name is irrelevant for this module's purposes"
    }, We);
    var vn = A("LabelRef", null, {
    ...
    var Cn = A("Infinity", null, {
        $documentation: "The `Infinity` value",
        value: 1 / 0
    }, En);
    var kn = A("Boolean", null, {
    ...
    var Mn = "break case catch class const continue debugger default delete do else export extends finally for function if in instanceof let new return switch throw try typeof var void while with";
    var qn = "false null true";
    var zn = "enum implements import interface package private protected public static super this " + qn + " " + Mn;
    ...
    var Vn = D(["in", "instanceof", "typeof", "new", "void", "delete", "++", "--", "+", "-", "!", "~", "&", "|", "^", "*", "**", "/", "%", ">>", "<<", ">>>", "<", ">", "<=", ">=", "==", "===", "!=", "!==", "?", "=", "+=", "-=", "/=", "*=", "**=", "%=", ">>=", "<<=", ">>>=", "|=", "^=", "&=", "&&", "||"]);
    var Yn = D(n("  \n\r\t\f\v​           \u2028\u2029  　\ufeff"));
    var Jn = D(n("\n\r\u2028\u2029"));
    var Wn = D(n(";]),:"));
    var Xn = D(n("[{(,;:"));
    ...
    function rt(e) {
        var n = e.charCodeAt(0);
        return Zn.ID_Continue.test(e) || 36 == n || 95 == n || 8204 == n || 8205 == n
    }
    function ot(e) {
    ...
    function vt(e, n) {
        ...
        var t = {
            input: "string" == typeof e ? function(e, n, t, i) {
                var r = {
                    text: e,
                    filename: n,
                    pos: 0,
                ...
                var l = !1;
                function p(t, i, o) {
                    r.regex_allowed = "operator" == t && !lt(i) || "keyword" == t && jn(i) || "punc" == t && Xn(i) || "arrow" == t;
                    if ("punc" == t && "." == i)
                        l = !0;
                    else if (!o)
                        l = !1;
                ...
                function m(e) {
                    ...
                    case 117:
                        if ("{" == o()) {
                            a(!0);
                            if ("}" === o())
                                h("Expecting hex-character between {}");
                            for (; "0" == o(); )
                                a(!0);
                            var t, i = f("}", !0) - r.pos;
                            ...
                            return function(e) {
                                if (e > 65535)
                                    return String.fromCharCode(55296 + ((e -= 65536) >> 10)) + String.fromCharCode(e % 1024 + 56320);
                    ...
                    if (n >= "0" && n <= "7")
                        return function(e) {
                            var n = o();
                            if (n >= "0" && n <= "7")
                                if ((e += a(!0))[0] <= "3" && (n = o()) >= "0" && n <= "7")
                                    e += a(!0);
                            if ("0" === e)
                                return "\0";
                            if (e.length > 0 && T.has_directive("use strict"))
                                h("Legacy octal escape sequences are not allowed in strict mode");
                ...
                function _(e) {
                    ...
                    for (; e > 0; --e) {
                        ...
                        if (isNaN(t))
                            h("Invalid hex-character pattern in string");
                        n = n << 4 | t
                    }
                    return n
                }
                var D = S("Unterminated string constant", function(e) {
                    ...
                    for (; ; ) {
                        ...
                        if ("\\" == i)
                            ...
                            h("Unterminated string constant");
                        else if (i == n)
                            break;
                        t += i
                    }
                ...
                var g = S("Unterminated template", function(e) {
                    ...
                    for (; "`" != (n = a(!0, !0)); ) {
                        if ("\r" == n) {
                            ...
                            a(!0, !0);
                            r.brace_counter++;
                            (t = p(e ? "template_head" : "template_substitution", i)).begin = e;
                            t.raw = s;
                            t.end = !1;
                            return t
                        }
                ...
                var y = S("Unterminated multiline comment", function() {
                    ...
                    var n = f("*/", !0);
                    var t = r.text.substring(r.pos, n).replace(/\r\n|\r|\u2028|\u2029/g, "\n");
                    s(function(e) {
                        var n = 0;
                        for (var t = 0; t < e.length; t++)
                ...
                var E = S("Unterminated identifier name", function() {
                    ...
                    for (; null != (e = o()); ) {
                        if ("\\" === (e = o())) {
                            if (!rt(e = i()))
                                h("Invalid escaped identifier char")
                        } else {
                            if (!rt(e))
                                break;
                            a()
                ...
                function w(e) {
                    return p("operator", function e(n) {
                        if (!o())
                            return n;
                        var t = n + o();
                        if (Vn(t)) {
                ...
                function B() {
                    ...
                    if (l)
                        return p("name", e);
                    return qn(e) ? p("atom", e) : !Mn(e) ? p("name", e) : Vn(e) ? p("operator", e) : p("keyword", e)
                }
                function S(e, n) {
                    return function(t) {
                        try {
                ...
                function T(e) {
                    ...
                    for (; ; ) {
                        ...
                        case 125:
                            r.brace_counter--;
                            if (r.template_braces.length > 0 && r.template_braces[r.template_braces.length - 1] === r.brace_counter)
                                return g(!1)
                        }
                        if (nt(f))
                            return v();
                ...
                ;
                return T
            }(e, n.filename, n.html5_comments, n.shebang) : e,
            token: null,
            prev: null,
            peeked: null,
            in_function: 0,
        ...
        function s() {
            ...
            if (t.peeked) {
                ...
                t.token = t.input();
            t.in_directives = t.in_directives && ("string" == t.token.type || r("punc", ";"));
            return t.token
        }
        function u() {
            return t.prev
        ...
        function f(e, n, i, r) {
            ...
            st(e, o.filename, null != n ? n : o.tokline, null != i ? i : o.tokcol, null != r ? r : o.tokpos)
        }
        function c(e, n) {
            f(n, e.line, e.col)
        }
        ...
        function p(e, n) {
            if (r(e, n))
                return s();
            c(t.token, "Unexpected token " + t.token.type + " «" + t.token.value + "», expected " + e + " «" + n + "»")
        }
        function d(e) {
            return p("punc", e)
        }
        function h(e) {
            return e.nlb || !g(e.comments_before, function(e) {
                return !e.nlb
            })
        }
        function v() {
        ...
        var x = E(function(e) {
            ...
            case "string":
                if (t.in_directives) {
                    var a = o();
                    if (-1 == t.token.raw.indexOf("\\") && (ut(a, "punc", ";") || ut(a, "punc", "}") || h(a) || ut(a, "eof")))
            ...
            case "name":
                ...
                return ut(o(), "punc", ":") ? function() {
                    var e = bt(ln);
                    if ("await" === e.name && _())
                        c(t.prev, "await cannot be used as label inside async function");
                    if (i(function(n) {
                    ...
                    if (!(n instanceof z))
                        e.references.forEach(function(n) {
                            if (n instanceof ue) {
                                n = n.label.start;
                                f("Continue label `" + e.name + "` refers to non-IterationStatement.", n.line, n.col, n.pos)
                            }
                        });
                    return new q({
                        body: n,
            ...
            case "keyword":
                ...
                case "for":
                    ...
                    return function() {
                        ...
                        if (!r("punc", ";")) {
                            e = r("keyword", "var") ? (s(),
                            We(!0)) : r("keyword", "let") ? (s(),
                            Ke(!0)) : r("keyword", "const") ? (s(),
                            Dn(!0)) : St(!0, !0);
                            var n = r("operator", "in");
                            var t = r("name", "of");
                            if (n || t) {
                                if (e instanceof _e) {
                                    if (e.definitions.length > 1)
                                        f("Only one variable declaration allowed in for..in loop", e.start.line, e.start.col, e.start.pos)
                                } else if (!(Ct(e) || (e = kt(e))instanceof K))
                                    f("Invalid left-hand side in for..in loop", e.start.line, e.start.col, e.start.pos);
                                s();
                                if (n)
                                    return function(e) {
                                        var n = St(!0);
                ...
                case "try":
                    ...
                    return function() {
                        ...
                        if (!n && !i)
                            f("Missing catch/finally blocks");
                        return new he({
                            body: e,
                            bcatch: n,
                            bfinally: i
                ...
                case "export":
                    if (!ut(o(), "punc", "(")) {
                        ...
                        return function() {
                            ...
                            var c;
                            var p;
                            if (r("punc", "{") || n && (r("keyword", "class") || r("keyword", "function")) && ut(o(), "punc")) {
                                c = St(!1);
                                D()
                            } else if ((f = x(n))instanceof _e && n)
                                l(f.start);
        ...
        function T(e) {
            ...
            if (null != r) {
                ...
                f(e.TYPE + " not inside a loop or switch");
            D();
            var o = new e({
                label: r
            });
        ...
        var M = function(e, n, i) {
            if (h(t.token))
                f("Unexpected newline before arrow (=>)");
            p("arrow", "=>");
            var o = ae(r("punc", "{"), !1, i);
            return new G({
                start: e,
                ...
                add_parameter: function(n) {
                    if (void 0 !== t["$" + n.value]) {
                        ...
                        if (e)
                            ...
                            case "yield":
                                if (a)
                                    c(n, "Unexpected " + n.value + " identifier as parameter inside strict mode");
                                break;
                            default:
                                if (zn(n.value))
                                    l()
        ...
        function te(e, n) {
            ...
            var o = !1;
            if (void 0 === e)
                e = L(!0, t.input.has_directive("use strict"));
            if (r("expand", "...")) {
                o = t.token;
        ...
        function ie(e, n) {
            ...
            var h = t.token;
            if (void 0 === e)
                e = L(!1, t.input.has_directive("use strict"));
            n = void 0 === n ? nn : n;
            if (r("punc", "[")) {
                s();
                for (; !r("punc", "]"); ) {
                    ...
                    if (c) {
                        if (!r("punc", "]"))
                            f("Rest element must be last element");
                        i[i.length - 1] = new Y({
                            start: p,
                ...
                for (; !r("punc", "}"); ) {
                    ...
                    if (r("name") && (ut(o(), "punc") || ut(o(), "operator")) && -1 !== [",", "}", "="].indexOf(o().value)) {
                        e.add_parameter(t.token);
                        var v = u();
                        var m = bt(n);
                        if (c)
        ...
        function ae(e, i, o, a, u) {
            ...
            ++t.in_function;
            if (i)
                t.in_generator = t.in_function;
            if (o)
                t.in_async = t.in_function;
            if (u)
                !function(e) {
                    t.token;
            ...
            for (; ; ) {
                ...
                if (r("punc", "{") || r("punc", "["))
                    o = new Fe({
                        start: t.token,
                        name: ie(void 0, a),
                        value: r("operator", "=") ? (p("operator", "="),
                        St(!1, e)) : null,
                        end: u()
                    });
                else if ("import" == (o = new Fe({
                    start: t.token,
                    name: bt(a),
                    value: r("operator", "=") ? (s(),
                    St(!1, e)) : !e && "const" === n ? f("Missing initializer in const declaration") : null,
                    end: u()
                })).name.name)
        ...
        function Fn(e, n, t, i) {
            ...
            if (e instanceof He)
                ...
                return r(Fn(e.left, 0, 0, e.right), i);
            else if (e instanceof je) {
                e.left = Fn(e.left, 0, e.left);
                return e
            } else
                f("Invalid function parameter", e.start.line, e.start.col)
        }
        var wn = function(e, i) {
            if (r("operator", "new"))
                return function(e) {
            ...
            if (r("punc")) {
                ...
                case "(":
                    ...
                    if (i && r("arrow", "=>"))
                        return M(a, c.map(Fn), !!f);
                    var h = f ? new we({
                        expression: f,
                        args: c
                    }) : 1 == c.length ? c[0] : new Ce({
                        expressions: c
                    });
                    if (h.start) {
        ...
        function at(e, n, i) {
            ...
            if ("async" === e && !r("punc", "(") && !r("punc", ",") && !r("punc", "}")) {
                a = !0;
                c = t.token;
                e = _t()
            }
        ...
        function _t() {
            ...
            case "operator":
                ...
                if (-1 === ["delete", "in", "instanceof", "new", "typeof", "void"].indexOf(e.value))
                    l(e);
            case "name":
                if ("yield" == e.value)
                    if (m())
                        c(e, "Yield cannot be used as identifier inside generators");
                    else if (!ut(o(), "punc", ":") && !ut(o(), "punc", "(") && t.input.has_directive("use strict"))
        ...
        function yt(e) {
            ...
            var i = y(n, "comments_before_length") ? n.comments_before_length : t.length;
            for (; --i >= 0; ) {
                var r = t[i];
        ...
        var Ft = function(e, n) {
            ...
            if ("name" == i.type && "await" == i.value)
                if (_()) {
                    ...
                    return function() {
                        if (!_())
                            f("Unexpected await expression outside async function", t.prev.line, t.prev.col, t.prev.pos);
                        return new Tn({
                            expression: Ft(!0)
                        })
                    }()
        ...
        function wt(e, n, i) {
            ...
            case "delete":
                if (i instanceof pn && t.input.has_directive("use strict"))
                    f("Calling delete on expression not allowed in strict mode", i.start.line, i.start.col, i.start.pos)
            }
            return new e({
                operator: r,
                expression: i
        ...
        var xt = function(e, n, i) {
            ...
            if ("in" == o && i)
                o = null;
            if ("**" == o && e instanceof Oe && !ut(e.start, "punc", "(") && "--" !== e.operator && "++" !== e.operator)
                l(e.start);
                ...
                for (var t = 0; t < e.elements.length; t++) {
                    if (e.elements[t]instanceof Y) {
                        if (t + 1 !== e.elements.length)
                            c(e.elements[t].start, "Spread must the be last element in destructuring array");
        ...
        var Bt = function(e) {
            ...
            if ("name" == n.type && "yield" == n.value)
                if (m()) {
                    ...
                    return function() {
                        if (!m())
                            f("Unexpected yield expression outside generator function", t.prev.line, t.prev.col, t.prev.pos);
                        var e = !1;
                        var n = !0;
                        if (v() || r("punc") && Wn(t.token.value))
                            n = !1;
                        else if (r("operator", "*")) {
                            e = !0;
                            s()
    ...
    !function(e) {
        ...
        n(he, function(e, n) {
            e.body = t(e.body, n);
            if (e.bcatch)
                e.bcatch = e.bcatch.transform(n);
            if (e.bfinally)
                e.bfinally = e.bfinally.transform(n)
        });
        n(ve, function(e, n) {
        ...
        n(Ie, function(e, n) {
            if (e.key instanceof w)
                e.key = e.key.transform(n);
            e.value = e.value.transform(n)
        });
        n(Ve, function(e, n) {
            if (e.name)
                e.name = e.name.transform(n);
            if (e.extends)
                e.extends = e.extends.transform(n);
            e.properties = t(e.properties, n)
        });
        n(Y, function(e, n) {
            e.expression = e.expression.transform(n)
        ...
        n(Ee, function(e, n) {
            if (e.imported_name)
                e.imported_name = e.imported_name.transform(n);
            if (e.imported_names)
                t(e.imported_names, n);
        ...
        n(Ae, function(e, n) {
            ...
            if (e.exported_value)
                e.exported_value = e.exported_value.transform(n);
            if (e.exported_names)
                t(e.exported_names, n);
            if (e.module_name)
                e.module_name = e.module_name.transform(n)
        });
        n(ee, function(e, n) {
    ...
    _t.prototype = {
        unmangleable: function(e) {
            if (!e)
                e = {};
            return this.global && !e.toplevel || this.export || this.undeclared || !e.eval && (this.scope.uses_eval || this.scope.uses_with) || e.keep_fnames && (this.orig[0]instanceof on || this.orig[0]instanceof tn) || this.orig[0]instanceof rn || e.keep_classnames && (this.orig[0]instanceof sn || this.orig[0]instanceof an)
        },
        mangle: function(e) {
            ...
            if (this.global && n && n.has(this.name))
                ...
                if (this.global && n)
                    n.set(this.name, this.mangled_name)
            }
        },
        redefined: function() {
    ...
    V.DEFMETHOD("figure_out_scope", function(e) {
        ...
        var u = new $n(function(n, a) {
            if (n.is_block_scope()) {
                ...
                if (e.safari10)
                    if (n instanceof I || n instanceof R)
                        s.push(t);
                a();
                t = f;
                return !0
            ...
            if (n instanceof q) {
                var p = n.label;
                if (i.has(p.name))
                    throw Error(v("Label {name} defined twice", p));
                i.set(p.name, p);
                a();
                i.del(p.name);
                return !0
            ...
            if (n instanceof P) {
                for (var d = t; d; d = d.parent_scope)
                    d.uses_with = !0;
                return
            }
            if (n instanceof We)
            ...
            if (n instanceof on)
                ...
                if (n instanceof Ke)
                    h = t.def_variable(n, null);
                else
                    h = r.def_variable(n, "SymbolVar" == n.TYPE ? null : void 0);
                if (!g(h.orig, function(e) {
                    if (e === n)
                        return !0;
                    if (n instanceof Ke)
                    ...
                    st(n.name + " redeclared", n.start.file, n.start.line, n.start.col, n.start.pos);
                if (!(n instanceof nn))
                    _(h, 2);
                h.destructuring = o;
                if (r !== t) {
                ...
                t.def_variable(n).defun = r;
            else if (n instanceof vn) {
                var m = i.get(n.name);
                if (!m)
                    throw Error(v("Undefined label {name} [{line},{col}]", {
                        name: n.name,
                        line: n.start.line,
                        col: n.start.col
                    }));
            ...
            if (!(t instanceof V) && (n instanceof Ae || n instanceof Ee))
                st(n.TYPE + " statement may only appear at top level", n.start.file, n.start.line, n.start.col, n.start.pos);
            function _(e, n) {
                if (o) {
                    var t = 0;
                    do {
            ...
            if (t instanceof pn) {
                ...
                if ("eval" == r && u.parent()instanceof we)
                    for (var o = t.scope; o && !o.uses_eval; o = o.parent_scope)
                        o.uses_eval = !0;
                var a;
                if (u.parent()instanceof ye && u.parent(1).module_name || !(a = t.scope.find_variable(r)))
                    a = n.def_global(t);
    ...
    L.DEFMETHOD("def_variable", function(e, n) {
        ...
        if (t) {
            t.orig.push(e);
            if (t.init && (t.scope !== e.scope || t.init instanceof X))
                t.init = n
        } else {
            t = new _t(this,e,n);
    ...
    function Dt(e, n) {
        ...
        e: for (; ; ) {
            ...
            for (var o = i.length; --o >= 0; ) {
                var a = i[o];
                if (r == (a.mangled_name || a.unmangleable(n) && a.name))
                    continue e
            }
            return r
        }
    ...
    V.DEFMETHOD("find_colliding_names", function(e) {
        ...
        function r(t) {
            var r = t.name;
            if (t.global && n && n.has(r))
                r = n.get(r);
            else if (!t.unmangleable(e))
                return;
            i(r)
        }
    });
            ...
            w.prototype.print = function(n, t) {
                ...
                if (this instanceof We && !this.unmangleable(e))
                    ...
                    if (this instanceof Be)
                        gt.consider(this.property, -1);
                    else if (this instanceof Se)
                        !function e(n) {
                            if (n instanceof gn)
                                gt.consider(n.value, -1);
    ...
    function Et(e) {
        ...
        var p = 0;
        var d = "";
        var h = e.ascii_only ? function(n, t) {
            if (e.ecma >= 6)
                n = n.replace(/[\ud800-\udbff][\udc00-\udfff]/g, function(e) {
                    return "\\u{" + function(e, n) {
                        if (Qn(e.charAt(0)))
                            return 65536 + (e.charCodeAt(0) - 55296 << 10) + e.charCodeAt(1) - 56320;
        ...
        var A = -1;
        var F = "";
        var C, k, B = e.source_map && [];
        var S = B ? function() {
            B.forEach(function(n) {
                try {
                    e.source_map.add(n.token.file, n.line, n.col, n.token.line, n.token.col, !n.name && "name" == n.token.type ? n.token.value : n.name)
                } catch (e) {
        ...
        return {
            ...
            prepend_comments: n ? u : function(n) {
                var i = this;
                var r = n.start;
                if (!r)
                    return;
                if (r.comments_before && r.comments_before._dumped === i)
                    return;
                ...
                if (n instanceof ie && n.value) {
                    var a = new $n(function(e) {
                        var n = a.parent();
                        if (n instanceof ie || n instanceof Me && n.left === e || "Call" == n.TYPE && n.expression === e || n instanceof qe && n.condition === e || n instanceof Be && n.expression === e || n instanceof Ce && n.expressions[0] === e || n instanceof Se && n.expression === e || n instanceof $e) {
                            if (!e.start)
                                return;
            ...
            ,
            append_comments: n || t === f ? u : function(e, n) {
                var i = e.end;
                if (!i)
                    return;
                ...
                if (!r || r._dumped === this)
                    return;
                if (!(e instanceof x || g(r, function(e) {
    ...
    !function() {
        ...
        w.DEFMETHOD("print", function(e, n) {
            ...
            if (r instanceof L)
                t = r;
            else if (!i && r instanceof k && "use asm" == r.value)
                i = t;
            function a() {
        ...
        r(X, function(e) {
            if (E(e))
                return !0;
            if (e.option("webkit"))
                if ((n = e.parent())instanceof ke && n.expression === this)
                    return !0;
        ...
        r(Te, function(e) {
            var n = e.parent();
            return n instanceof ke && n.expression === this || n instanceof we && n.expression === this || n instanceof Me && "**" === n.operator && this instanceof Oe && n.left === this && "++" !== this.operator && "--" !== this.operator
        });
        r(Tn, function(e) {
            var n = e.parent();
            return n instanceof ke && n.expression === this || n instanceof we && n.expression === this || e.option("safari10") && n instanceof Oe
        });
        r(Ce, function(e) {
            var n = e.parent();
            return n instanceof we || n instanceof Te || n instanceof Me || n instanceof Fe || n instanceof ke || n instanceof Ne || n instanceof Ie || n instanceof qe || n instanceof G || n instanceof je || n instanceof Y || n instanceof U && this === n.object || n instanceof On
        });
        r(Me, function(e) {
            var n = e.parent();
            if (n instanceof we && n.expression === this)
                return !0;
            if (n instanceof Te)
                return !0;
            ...
            if (n instanceof Me) {
                ...
                var r = this.operator
                  , o = dt[r];
                if (i > o || i == o && this === n.right)
                    return !0
            }
        });
        r(On, function(e) {
            var n = e.parent();
            if (n instanceof Me && "=" !== n.operator)
                return !0;
            if (n instanceof we && n.expression === this)
                return !0;
            if (n instanceof qe && n.condition === this)
                return !0;
            if (n instanceof Te)
                return !0;
            if (n instanceof ke && n.expression === this)
        ...
        r(we, function(e) {
            ...
            if (t instanceof xe && t.expression === this)
                return !0;
            return this.expression instanceof X && t instanceof ke && t.expression === this && (n = e.parent(1))instanceof ze && n.left === t
        });
        r(xe, function(e) {
            var n = e.parent();
            if (!p(this, e) && (n instanceof ke || n instanceof we && n.expression === this))
                return !0
        });
        r(bn, function(e) {
            var n = e.parent();
        ...
        r([ze, qe], function(e) {
            ...
            if (n instanceof Te)
                return !0;
            if (n instanceof Me && !(n instanceof ze))
                return !0;
            if (n instanceof we && n.expression === this)
                return !0;
            if (n instanceof qe && n.condition === this)
            ...
            if (n instanceof ke && n.expression === this)
                return !0;
            if (this instanceof ze && this.left instanceof K && !1 === this.left.is_array)
                return !0
        });
        e(k, function(e, n) {
        ...
        function o(e, t, i, r) {
            ...
            e.forEach(function(e, r) {
                if (!0 === n && !(e instanceof k || e instanceof $ || e instanceof B && e.body instanceof gn))
                    n = !1;
                if (!(e instanceof $)) {
                    i.indent();
                    e.print(i);
                ...
                if (!0 === n && e instanceof B && e.body instanceof gn)
                    n = !1
            });
            n = !1
        }
        ...
        e(ee, function(e, n) {
            ...
            for (var i = 0; i < e.segments.length; i++)
                if (!(e.segments[i]instanceof ne)) {
                    ...
                    n.print(e.segments[i].raw);
                else
                    n.print_template_string_chars(e.segments[i].value);
            n.print("`")
        });
        G.DEFMETHOD("_do_print", function(e) {
            var n = this;
            var t = e.parent();
            var i = t instanceof Me || t instanceof Te || t instanceof we && n === t.expression;
            if (i)
                e.print("(");
            if (n.async) {
                e.print("async");
        ...
        e(Tn, function(e, n) {
            ...
            n.space();
            var t = e.expression;
            var i = !(t instanceof we || t instanceof pn || t instanceof ke || t instanceof Te || t instanceof Dn);
            if (i)
                n.print("(");
            e.expression.print(n);
            if (i)
        ...
        e(fe, function(e, n) {
            ...
            if (e.alternative) {
                ...
                n.print("else");
                n.space();
                if (e.alternative instanceof fe)
        ...
        _e.DEFMETHOD("_do_print", function(e, n) {
            ...
            var t = e.parent();
            if (!(t instanceof I || t instanceof R) || t.init !== this)
                e.semicolon()
        });
        e(ge, function(e, n) {
            e._do_print(n, "let")
        ...
        e(Ae, function(e, n) {
            ...
            if (e.exported_names)
                ...
                e.exported_value.print(n);
            else if (e.exported_definition) {
                e.exported_definition.print(n);
                if (e.exported_definition instanceof _e)
                    return
            }
            if (e.module_name) {
                n.space();
        ...
        e(Oe, function(e, n) {
            var t = e.operator;
            n.print(t);
            if (/^[a-z]/i.test(t) || /[+-]$/.test(t) && e.expression instanceof Oe && /^[+-]/.test(e.expression.operator))
                n.space();
            e.expression.print(n)
        });
        e($e, function(e, n) {
        ...
        e(Me, function(e, n) {
            ...
            if (">" == t[0] && e.left instanceof $e && "--" == e.left.operator)
                ...
                n.space();
            n.print(t);
            if (("<" == t || "<<" == t) && e.right instanceof Oe && "!" == e.right.operator && e.right.expression instanceof Oe && "--" == e.right.expression.operator)
                n.print(" ");
            else
                n.space();
            e.right.print(n)
        ...
        e(Ve, function(e, n) {
            ...
            if (e.extends) {
                var t = !(e.extends instanceof pn || e.extends instanceof ke || e.extends instanceof Je || e.extends instanceof X);
                n.print("extends");
                if (t)
                    n.print("(");
                else
        ...
        function c(e, n, t) {
            if (t.option("quote_keys"))
                ...
                if (n && t.option("keep_quoted_props"))
                    t.print_string(e, n);
                else
                    t.print_name(e);
            else
        ...
        e(Re, function(e, n) {
            ...
            if (i && e.value instanceof We && ot(e.key) && t(e.value) === e.key && tt(e.key))
                c(e.key, e.quote, n);
            else if (i && e.value instanceof je && e.value.left instanceof We && ot(e.key) && t(e.value.left) === e.key) {
                c(e.key, e.quote, n);
                n.space();
                n.print("=");
                n.space();
        ...
        Ie.DEFMETHOD("_print_getter_setter", function(e, n) {
            ...
            if (t.key instanceof rn)
                c(t.key.name, t.quote, n);
            else
                n.with_square(function() {
                    t.key.print(n)
                });
        ...
        e(bn, function(e, n) {
            if (i && e.start && null != e.start.raw)
                n.print(e.start.raw);
            else
                n.print(d(e.getValue()))
        });
        e(yn, function(e, n) {
            var t = e.getValue();
            var i = t.toString();
            if (t.raw_source)
                i = "/" + t.raw_source + i.slice(i.lastIndexOf("/"));
            i = n.to_utf8(i);
            n.print(i);
            var r = n.parent();
        ...
        function l(e, n) {
            if (n.option("bracketize"))
                h(e, n);
            else if (!e || e instanceof $)
                n.force_semicolon();
            else
                e.print(n)
        }
        ...
        function d(e) {
            var n, t = e.toString(10), i = [t.replace(/^0\./, ".").replace("e+", "e")];
            if (Math.floor(e) === e) {
                if (e >= 0)
                    ...
                    i.push("-0x" + (-e).toString(16).toLowerCase(), "-0" + (-e).toString(8));
                if (n = /^(.*?)(0+)$/.exec(e))
                    i.push(n[1] + "e" + n[2].length)
            } else if (n = /^0?\.(0+)(.*)$/.exec(e))
                i.push(n[2] + "e-" + (n[1].length + n[2].length), t.substr(t.indexOf(".")));
            return function(e) {
                var n = e[0]
                  , t = n.length;
    ...
    s(At.prototype, {
        ...
        in_boolean_context: function() {
            ...
            for (var n, t = 0; n = this.parent(t); t++) {
                if (n instanceof B || n instanceof qe && n.condition === e || n instanceof j && n.condition === e || n instanceof I && n.condition === e || n instanceof fe && n.condition === e || n instanceof Oe && "!" == n.operator && n.expression === e)
                    return !0;
                if (n instanceof Me && ("&&" == n.operator || "||" == n.operator) || n instanceof qe || n.tail_node() === e)
                    e = n;
                else
                    return !1
            }
        ...
        compress: function(e) {
            ...
            for (var o = 0; o < n; o++) {
                ...
                if (o > 0 || this.option("reduce_vars"))
                    e.reset_opt_flags(this);
                e = e.transform(this);
                if (n > 1) {
                    var a = 0;
                    e.walk(new $n(function() {
                        a++
                    }
                    ));
    ...
    !function() {
        ...
        L.DEFMETHOD("process_expression", function(e, n) {
            ...
            var i = new mt(function(r) {
                ...
                if (r instanceof Ve || r instanceof J && r !== t)
                    return r;
                if (r instanceof T) {
        ...
        !function(e) {
            ...
            function n(e, n) {
                ...
                n.direct_access = !1;
                n.escaped = !1;
                if (n.scope.uses_eval || n.scope.uses_with)
                    n.fixed = !1;
                else if (n.orig[0]instanceof Qe || !e.exposed(n))
                    n.fixed = n.init;
                else
                    n.fixed = !1;
                n.recursive_refs = 0;
            ...
            function f(e, n) {
                if (e.safe_ids[n.id]) {
                    if (null == n.fixed) {
                        var t = n.orig[0];
                        if (t instanceof nn || "arguments" == t.name)
                            return !1;
                        n.fixed = s(wn, t)
                    }
                    return !0
            ...
            function l(e, n) {
                ...
                if (e instanceof Ne) {
                    ...
                    if ("length" == n)
                        return _(i.length, e);
                    if ("number" == typeof n && n in i)
                        t = i[n]
                } else if (e instanceof He) {
                    n = "" + n;
                    var r = e.properties;
                    for (var o = r.length; --o >= 0; ) {
                        if (!(r[o]instanceof Re))
                            return;
                        if (!t && r[o].key === n)
                            t = r[o].value
                    }
            ...
            e(ze, function(e) {
                ...
                if ("=" != n.operator || !(n.left instanceof pn))
                    return;
            ...
            e(pn, function(e, n, t) {
                ...
                if (1 == i.references.length && !i.fixed && i.orig[0]instanceof tn)
                    e.loop_ids[i.id] = e.in_loop;
                var r;
                if (void 0 === i.fixed || !f(e, i) || "m" == i.single_use)
                    i.fixed = !1;
                else if (i.fixed) {
                    if ((r = this.fixed_value())instanceof J && Pn(e, i))
                        i.recursive_refs++;
                    else if (r && !t.exposed(i) && function(e, n, t) {
                        return n.option("unused") && !t.scope.uses_eval && !t.scope.uses_with && t.references.length - t.recursive_refs == 1 && e.loop_ids[t.id] === e.in_loop
                    }(e, t, i))
                        i.single_use = r instanceof J || r instanceof Ve || i.scope === this.scope && r.is_constant_expression();
                    else
                        i.single_use = !1;
                    if (function e(n, t, i, r, o) {
                        var a = n.parent(r);
                        if (En(t, a) || !o && a instanceof we && a.expression === t && !(i instanceof G) && !(i instanceof Ve) && (!(i instanceof X) || !(a instanceof xe) && i.contains_this()))
                            return !0;
                ...
                !function e(n, t, i, r, o, a, s) {
                    ...
                    if (u instanceof ze && "=" == u.operator && r === u.right || u instanceof we && r !== u.expression || u instanceof ie && r === u.value && r.scope !== t.scope || u instanceof Fe && r === u.value || u instanceof On && r === u.value && r.scope !== t.scope) {
                        if (s > 1 && (!o || !o.is_constant_expression(i)))
                            s = 1;
                        if (!t.escaped || t.escaped > s)
                            t.escaped = s;
                        return
                    } else if (u instanceof Ne || u instanceof Tn || u instanceof Me && vn(u.operator) || u instanceof qe && r !== u.condition || u instanceof Y || u instanceof Ce && r === u.tail_node())
                        e(n, t, i, u, u, a + 1, s);
        ...
        function r(e) {
            if (e instanceof mn)
                return !0;
            if (e instanceof pn)
                return e.definition().orig[0]instanceof on;
            if (e instanceof ke) {
        ...
        function _(e, n) {
            ...
            default:
                ...
                throw Error(v("Can't handle constant of type: {type}", {
                    type: typeof e
                }))
            }
        }
        function A(e, n, t) {
            if (e instanceof Oe && "delete" == e.operator || e instanceof we && e.expression === n && (t instanceof ke || t instanceof pn && "eval" == t.name))
                return h(n, [s(bn, n, {
                    value: 0
                }), t]);
            return t
        ...
        function me(e) {
            return !(e instanceof Ye || e instanceof Z || e instanceof ge || e instanceof be || e instanceof Ae || e instanceof Ee)
        }
        function ye(e) {
            if (e instanceof z)
                return e.body instanceof O ? e.body : e;
            return e
        }
        function Ue(e) {
            if ("Call" != e.TYPE)
        ...
        var en = D("Array Boolean clearInterval clearTimeout console Date decodeURI decodeURIComponent encodeURI encodeURIComponent Error escape eval EvalError Function isFinite isNaN JSON Math Number parseFloat parseInt RangeError ReferenceError RegExp Object setInterval setTimeout String SyntaxError TypeError unescape URIError");
        pn.DEFMETHOD("is_declared", function(e) {
            return !this.definition().undeclared || e.option("unsafe") && en(this.name)
        });
        ...
        function fn(e, i) {
            ...
            do {
                u = !1;
                l(e);
                if (i.option("dead_code"))
                    v(e, i);
                if (i.option("if_return"))
                    p(e, i);
                if (i.sequences_limit > 0) {
                    D(e, i);
                    y(e, i)
                }
                if (i.option("join_vars"))
                    x(e);
                if (i.option("collapse_vars"))
                    c(e, i)
            } while (u && f-- > 0);
            function c(e, i) {
                if (a.uses_eval || a.uses_with)
                    return e;
                var f;
                var c = [];
                var l = i.self()instanceof he;
                var p = e.length;
                var h = new mt(function(e, n) {
                    if ($)
                        return e;
                    if (e instanceof ce) {
                        if (!O) {
                    ...
                    var f = h.parent();
                    if (e instanceof ze && "=" != e.operator && E.equivalent_to(e.left) || e instanceof Tn || e instanceof we && E instanceof ke && E.equivalent_to(e.expression) || e instanceof C || e instanceof K || e instanceof z && !(e instanceof I) || e instanceof he || e instanceof P || f instanceof I && e !== f.init || (x || !w) && e instanceof pn && !e.is_declared(i)) {
                        $ = !0;
                        return e
                    }
                    ...
                    var d;
                    if (e instanceof we || e instanceof ie || e instanceof ke && (x || e.expression.may_throw_on_access(i)) || e instanceof pn && (F[e.name] || x && !function(e) {
                        if (1 == e.orig.length && e.orig[0]instanceof tn)
                            return !0;
                        if (e.scope.get_defun_scope() !== a)
                            return !1;
                        return e.references.every(function(e) {
                            return e.scope.get_defun_scope() === a
                        })
                    }(e.definition())) || (d = function(e) {
                        if (e instanceof Fe)
                            return e.value && e.name;
                        return En(e.left, e)
                    }(e)) && (d instanceof ke || d.name in F) || k && (l ? e.has_side_effects(i) : function e(n, t) {
                        if (n instanceof ze)
                            return e(n.left, !0) || e(n.right);
                        if (n instanceof _e)
                            return !1;
                        if (n instanceof Te)
                            return e(n.expression, !0);
                        if (n instanceof Fe)
                        ...
                        if (t) {
                            ...
                            if (n instanceof pn)
                                return n.definition().scope !== a
                        }
                        return n.has_side_effects(i)
                    }(e)) || (x || !w) && (f instanceof Me && vn(f.operator) || f instanceof qe || f instanceof fe)) {
                        y = e;
                        if (e instanceof L)
                            $ = !0
                    }
                ...
                var v = new mt(function(e) {
                    ...
                    if (e instanceof pe || e instanceof L)
                        return e
                }
                );
                for (; --p >= 0; ) {
                    if (0 == p && i.option("unused"))
                        J();
                    var m = [];
                    W(e[p]);
                    for (; c.length > 0; ) {
                        ...
                        if (!w && E instanceof pn)
                            if ((U = E.definition()).references.length - U.replaced == (D instanceof Fe ? 1 : 2))
                                w = !0;
                        var x = ne(D);
                        var k = D.may_throw(i);
                        ...
                        var $ = !1
                          ...
                          , q = !f || !O;
                        if (!q) {
                            for (var N = i.self().argnames.lastIndexOf(D.name) + 1; !$ && N < f.length; N++)
                                f[N].transform(h);
                            q = !0
                        }
                        ...
                        if (b) {
                            ...
                            if ($ && U.references.length - U.replaced > M)
                                M = !1;
                            else {
                                $ = !1;
                                _ = 0;
                                O = S;
                                for (H = p; !$ && H < e.length; H++)
                                    e[H].transform(v);
                                b.single_use = !1
                            }
                        }
                ...
                function J() {
                    var e, r = i.self();
                    if (n(r) && !r.name && !r.uses_arguments && !r.uses_eval && (e = i.parent())instanceof we && e.expression === r && g(e.args, function(e) {
                ...
                function W(e) {
                    ...
                    if (e instanceof ze) {
                        ...
                        W(e.consequent);
                        W(e.alternative)
                    } else if (e instanceof _e && (i.option("unused") || !(e instanceof be)))
                        e.definitions.forEach(W);
                    else if (e instanceof j) {
                        W(e.condition);
                        if (!(e.body instanceof T))
                            W(e.body)
                    } else if (e instanceof ie) {
                        if (e.value)
                            W(e.value)
                ...
                function X(e) {
                    if (e instanceof Fe && e.name instanceof Ge) {
                        ...
                        if (r > 1 && !(e.name instanceof nn) || (a > 1 ? function(n) {
                            var t = e.value;
                            if (!(t instanceof pn))
                                return;
                            if ("arguments" == t.name)
                ...
                function ee(n) {
                    if (n.name instanceof nn) {
                        ...
                        if (o < 0)
                            t.args.length = Math.min(t.args.length, r.length - 1);
                        else {
                            var a = t.args;
                            if (a[o])
                                a[o] = s(bn, a[o], {
                    ...
                    var u = !1;
                    return e[p].transform(new mt(function(e, t, i) {
                        if (u)
                            return e;
                        if (e === n || e.body === n) {
                            u = !0;
            ...
            function p(e, n) {
                ...
                var i = function(e) {
                    ...
                    for (var t = e.length; --t >= 0; ) {
                        var i = e[t];
                        if (i instanceof fe && i.body instanceof re)
                            if (++n > 1)
                                return !0
                    }
                    return !1
                ...
                for (var o = e.length; --o >= 0; ) {
                    ...
                    if (a instanceof fe) {
                        if (v(p = Rn(a.body))) {
                            if (p.label)
                                m(p.label.thedef.references, p);
                            u = !0;
                            (a = a.clone()).condition = a.condition.negate(n);
                            var l = g(a.body, p);
                            a.body = s(O, a, {
                                body: M(a.alternative).concat(D())
                            });
                            a.alternative = s(O, a, {
                                body: l
                            });
                        ...
                        if (v(p = Rn(a.alternative))) {
                            ...
                            l = g(a.alternative, p);
                            a.alternative = s(O, a.alternative, {
                                body: l
                            });
                            e[o] = a.transform(n);
                            continue
                    ...
                    if (a instanceof fe && a.body instanceof re) {
                        var d = a.body.value;
                        if (!d && !a.alternative && (r && !c || c instanceof re && !c.value)) {
                            u = !0;
                            e[o] = s(B, a.condition, {
                                body: a.condition
                            });
                        ...
                        if (d && !a.alternative && (!c && r && i || c instanceof re)) {
                            u = !0;
                            (a = a.clone()).alternative = c || s(re, a, {
                                value: null
                            });
                            e.splice(o, 1, a.transform(n));
                            if (c)
                        ...
                        var h = e[y(o)];
                        if (n.option("sequences") && r && !a.alternative && h instanceof fe && h.body instanceof re && b(f) == e.length && c instanceof B) {
                            u = !0;
                ...
                function v(i) {
                    ...
                    for (var a = o + 1, s = e.length; a < s; a++) {
                        var u = e[a];
                        if (u instanceof be || u instanceof ge)
                            return !1
                    }
                    var f = i instanceof ae ? n.loopcontrol_target(i) : null;
                    return i instanceof re && r && (!(c = i.value) || c instanceof Oe && "void" == c.operator) || i instanceof ue && t === ye(f) || i instanceof se && f instanceof O && t === f;
                    var c
                }
                function D() {
                    var n = e.slice(o + 1);
            ...
            function v(e, n) {
                ...
                for (var r = 0, o = 0, a = e.length; r < a; r++) {
                    ...
                    if (s instanceof ae) {
                        ...
                        if (s instanceof se && !(f instanceof z) && ye(f) === i || s instanceof ue && ye(f) === i) {
                            if (s.label)
                                m(s.label.thedef.references, s)
                        } else
                            e[o++] = s
                    } else
                        e[o++] = s;
            ...
            function D(e, n) {
                ...
                for (var o = 0, a = e.length; o < a; o++) {
                    var f = e[o];
                    if (f instanceof B) {
                        if (t.length >= n.sequences_limit)
                            r();
                        var c = f.body;
                        if (t.length > 0)
                            c = c.drop_side_effect_free(n);
                        if (c)
                            F(t, c)
                    } else if (f instanceof _e && _(f) || f instanceof Z)
                        e[i++] = f;
                    else {
                        r();
                        e[i++] = f
            ...
            function y(e, n) {
                ...
                for (var o = 0; o < e.length; o++) {
                    ...
                    if (i)
                        if (a instanceof ie)
                            a.value = t(a.value || s(wn, a).transform(n));
                        else if (a instanceof I) {
                            if (!(a.init instanceof _e)) {
                                var f = !1;
                                i.body.walk(new $n(function(e) {
                                    if (f || e instanceof L)
                                        return !0;
                                    if (e instanceof Me && "in" == e.operator) {
                                        f = !0;
                            ...
                            a.condition = t(a.condition);
                        else if (a instanceof ce)
                            a.expression = t(a.expression);
            ...
            function E(e, n) {
                ...
                do {
                    ...
                    if ("=" != u.operator)
                        break;
                    if (!(u.left instanceof ke))
                        break;
                    var f = u.left.expression;
                    if (!(f instanceof pn))
                        break;
                    if (t.name.name != f.name)
                        break;
                    if (!u.right.is_constant_expression(a))
                        break;
                    ...
                    if (i.option("ecma") < 6 && i.has_directive("use strict"))
                        if (!g(t.value.properties, function(e) {
                            return e.key != c && e.key.name != c
                        }))
                            break;
                    t.value.properties.push(s(Re, u, {
                        key: c,
                        value: u.right
                    }));
                    r.shift();
        ...
        function cn(e, n, t) {
            ...
            n.walk(new $n(function(i) {
                if (i instanceof De) {
                    e.warn("Declarations in unreachable code! [{file}:{line},{col}]", i.start);
        ...
        function hn(e, n) {
            return e.is_undefined || e instanceof wn || e instanceof Oe && "void" == e.operator && !e.expression.has_side_effects(n)
        }
        !function(e) {
            ...
            e(He, function(e) {
                ...
                for (var t = this.properties.length; --t >= 0; )
                    if (this.properties[t]._dot_throw(e))
                        return !0;
                return !1
            });
            e(Ie, f);
        ...
        !function(e) {
            ...
            e(Me, function() {
                return t(this.operator, i) || vn(this.operator) && this.left.is_boolean() && this.right.is_boolean()
            });
            e(qe, function() {
        ...
        var _n = D("delete ++ --");
        function En(e, n) {
            if (n instanceof Te && _n(n.operator))
                return n.expression;
            if (n instanceof ze && n.left === e)
                return e
        }
        !function(e) {
        ...
        var Nn = {
            ...
            String: ["charAt", "charCodeAt", "concat", "indexOf", "italics", "lastIndexOf", "match", "replace", "search", "slice", "split", "substr", "substring", "trim"].concat(jn)
        };
        zn(Nn);
        var Hn = {
            Array: ["isArray"],
        ...
        !function(e) {
            ...
            w.DEFMETHOD("is_constant", function() {
                if (this instanceof Dn)
                    ...
                    return this instanceof Oe && this.expression instanceof Dn && n(this.operator)
            });
            e(x, function() {
                throw Error(v("Cannot evaluate a statement [{file}:{line},{col}]", this.start))
            });
            e(J, l);
            e(Ve, l);
            e(w, l);
                ...
                if (e.option("unsafe")) {
                    ...
                    for (var i = 0, r = this.properties.length; i < r; i++) {
                        ...
                        if (a instanceof We)
                            ...
                            if ((a = a._eval(e, n)) === o.key)
                                return this;
                        if ("function" == typeof Object.prototype[a])
                            return this;
                        if (o.value instanceof X)
                            continue;
            ...
            e(Oe, function(e, n) {
                ...
                if (e.option("typeofs") && "typeof" == this.operator && (t instanceof J || t instanceof pn && t.fixed_value()instanceof J))
                    return "function";
                if ((t = t._eval(e, n)) === this.expression)
                    return this;
            ...
            e(ke, function(e, n) {
                if (e.option("unsafe")) {
                    var r = this.property;
                    if (r instanceof w)
                        if ((r = r._eval(e, n)) === this.property)
                            return this;
                ...
                if (e.option("unsafe") && i instanceof ke) {
                    ...
                    if (Xe(a)) {
                        if (!(Hn[a.name] || f)(r))
                            return this;
                        o = t[a.name]
                    } else if ((o = a._eval(e, n + 1)) === a || !(o && Nn[o.constructor.name] || f)(r))
                        return this;
                    var s = [];
        ...
        var In = D("Boolean decodeURI decodeURIComponent Date encodeURI encodeURIComponent Error escape EvalError isFinite isNaN Number Object parseFloat parseInt RangeError ReferenceError String SyntaxError TypeError unescape URIError");
        we.DEFMETHOD("is_expr_pure", function(e) {
            if (e.option("unsafe")) {
                var n = this.expression;
                if (Xe(n) && In(n.name))
                    return !0;
                if (n instanceof Be && Xe(n.expression) && (Hn[n.expression.name] || f)(n.property))
                    return !0
            }
        ...
        Be.DEFMETHOD("is_call_pure", function(e) {
            ...
            if (n instanceof Ne)
                ...
                t = Nn.Boolean;
            else if (n.is_number(e))
                t = Nn.Number;
            else if (n instanceof yn)
                t = Nn.RegExp;
            else if (n.is_string(e))
                t = Nn.String;
        ...
        !function(e) {
            ...
            e(we, function(e) {
                if (!this.is_expr_pure(e) && (!this.expression.is_call_pure(e) || this.expression.has_side_effects(e)))
                    return !0;
            ...
            e(Ie, function(e) {
                if (this.key instanceof Re && this.key.has_side_effects(e))
                    return !0;
        ...
        !function(e) {
            ...
            e(ze, function(e) {
                return "=" != this.operator && this.left.may_throw(e) || this.right.may_throw(e)
            });
            e(Me, function(e) {
            ...
            e(we, function(e) {
                ...
                if (this.is_expr_pure(e))
                    return !1;
                if (this.expression.may_throw(e))
                    return !0;
            ...
            e(he, function(e) {
                return n(this.body, e) || this.bcatch && this.bcatch.may_throw(e) || this.bfinally && this.bfinally.may_throw(e)
            });
            e(Te, function(e) {
        ...
        !function(e) {
            ...
            e(le, n);
            e(fe, function() {
                return this.alternative && Rn(this.body) && Rn(this.alternative) && this
            })
        }(function(e, n) {
            e.DEFMETHOD("aborts", n)
        });
        e(k, function(e, n) {
            if (n.has_directive(e.value) !== e)
                return s($, e);
            return e
        });
        e(C, function(e, n) {
            if (n.option("drop_debugger"))
                return s($, e);
            return e
        });
        e(q, function(e, n) {
        ...
        e(O, function(e, n) {
            ...
            case 1:
                if (!n.has_directive("use strict") && n.parent()instanceof fe || me(e.body[0]))
                    return e.body[0];
                break;
            case 0:
                return s($, e)
        ...
        L.DEFMETHOD("drop_unused", function(e) {
            ...
            var F = new mt(function(o, a, f) {
                ...
                if (_ !== n)
                    return;
                if (o.name && (!e.option("keep_classnames") && o instanceof Je || !e.option("keep_fnames") && o instanceof X))
                ...
                if (o instanceof J && !(o instanceof W)) {
                    ...
                    for (var b = o.argnames, y = b.length; --y >= 0; ) {
                        ...
                        if (!(E instanceof K || E.definition().id in u)) {
                            ...
                            if (D) {
                                b.pop();
                                e[E.unreferenced() ? "warn" : "info"]("Dropping unused function argument {name} [{file}:{line},{col}]", j(E))
                            }
                        } else
                            D = !1
                    }
                ...
                if ((o instanceof Z || o instanceof Ye) && o !== n) {
                    ...
                    if (!((w = o.name.definition()).id in u || !t && w.global)) {
                        e[o.name.unreferenced() ? "warn" : "info"]("Dropping unused function {name} [{file}:{line},{col}]", j(o.name));
                        w.eliminated++;
                        return s($, o)
                    }
                }
                if (o instanceof _e && !(p instanceof R && p.init === o)) {
                    ...
                    o.definitions.forEach(function(n) {
                        ...
                        if (!i && !x || t.id in u) {
                            ...
                            if (n.name instanceof Ze) {
                                var r = l.get(t.id);
                                if (r.length > 1 && (!n.value || t.orig.indexOf(n.name) > t.eliminated)) {
                                    e.warn("Dropping duplicated definition of variable {name} [{file}:{line},{col}]", j(n.name));
                                    if (n.value) {
                            ...
                            var p;
                            if (p = n.value && n.value.drop_side_effect_free(e)) {
                                e.warn("Side effects in initialization of unused variable {name} [{file}:{line},{col}]", j(n.name));
                                T.push(p)
                            } else
                                e[n.name.unreferenced() ? "warn" : "info"]("Dropping unused variable {name} [{file}:{line},{col}]", j(n.name));
                            t.eliminated++
                        }
                    });
            ...
            function w(e, t) {
                var i, s = r(e);
                if (s instanceof pn && !o(e.left, Ke) && n.variables.get(s.name) === (i = s.definition())) {
                    if (e instanceof ze) {
                        e.right.walk(D);
                        if (e.left.fixed_value() === e.right)
                            c[i.id] = e
                    }
                    return !0
                }
            ...
            if (t || r) {
                ...
                var l = new mt(function(i) {
                    if (i !== n) {
                        ...
                        if (t && i instanceof Z && !(l.parent()instanceof Ae) && l.parent() === n) {
                            a.push(i);
                            return s($, i)
                        }
                        if (r && i instanceof De) {
                            i.definitions.forEach(function(e) {
                                if (e.name instanceof K)
                                    return;
                                u.set(e.name.name, e);
                                ++f
                            });
                ...
                if (f > 0) {
                    var p = [];
                    u.each(function(e, t) {
                        if (n instanceof J && i(function(n) {
                    ...
                    if (p.length > 0) {
                        for (var d = 0; d < n.body.length; ) {
                            if (n.body[d]instanceof B) {
                                var v, _, D = n.body[d].body;
                                if (D instanceof ze && "=" == D.operator && (v = D.left)instanceof We && u.has(v.name)) {
                                    if ((g = u.get(v.name)).value)
                                        break;
                                    g.value = D.right;
                                    m(p, g);
                                    p.push(g);
                                ...
                                if (D instanceof Ce && (_ = D.expressions[0])instanceof ze && "=" == _.operator && (v = _.left)instanceof We && u.has(v.name)) {
                                    var g;
                                    if ((g = u.get(v.name)).value)
                                        break;
                                    g.value = _.right;
        ...
        L.DEFMETHOD("hoist_properties", function(e) {
            ...
            var r = new mt(function(o, a) {
                if (o instanceof _e && r.parent()instanceof Ae)
                    return o;
                if (o instanceof Fe) {
                    var u;
                    if ((p = o.name).scope === n && 1 != (l = p.definition()).escaped && !l.single_use && !l.direct_access && !e.exposed(l) && !t(l) && (u = p.fixed_value()) === o.value && u instanceof He) {
                        a(o, this);
                        var f = new b;
                        var c = [];
        ...
        !function(e) {
            ...
            e(we, function(e, i) {
                if (!this.is_expr_pure(e)) {
                    ...
                    if (n(this.expression) && (!this.expression.name || !this.expression.name.definition().references.length)) {
                        var o = this.clone();
            ...
            e(Me, function(e, n) {
                ...
                if (!t)
                    return this.left.drop_side_effect_free(e, n);
                if (vn(this.operator)) {
                    if (t === this.right)
                        return this;
                    var i = this.clone();
                    ...
                    if (!r)
                        return this.right.drop_side_effect_free(e, n);
                    return h(this, [r, t])
                }
            });
            e(ze, function(e) {
                var n = this.left;
                if (n.has_side_effects(e) || e.has_directive("use strict") && n instanceof ke && n.expression.is_constant())
                    return this;
                this.write_only = !0;
                for (; n instanceof ke; )
                    n = n.expression;
            ...
            e(qe, function(e) {
                ...
                if (n === this.consequent && t === this.alternative)
                    return this;
                if (!n)
                    return t ? s(Me, this, {
                        operator: "||",
            ...
            e(Te, function(e, n) {
                ...
                if (n && t && Ue(t)) {
                    if (t === this.expression && "!" == this.operator)
                        return this;
                    return t.negate(e, n)
                }
                return t
            ...
            e(Se, function(e, n) {
                ...
                var t = this.expression.drop_side_effect_free(e, n);
                if (!t)
                    return this.property.drop_side_effect_free(e, n);
        ...
        e(N, function(e, n) {
            ...
            if (!(t instanceof w)) {
                ...
                var r = new $n(function(n) {
                    if (n instanceof L || i)
                        return !0;
                    if (n instanceof ae && r.loopcontrol_target(n) === e)
                        return i = !0
                }
                );
                var o = n.parent();
        ...
        e(I, function(e, n) {
            ...
            if (e.condition) {
                ...
                if (n.option("dead_code")) {
                    if (t instanceof w)
                        t = e.condition.tail_node().evaluate(n);
                    if (!t) {
                        var r = [];
                        cn(n, e.body, r);
                        if (e.init instanceof x)
                            r.push(e.init);
                        else if (e.init)
                            r.push(s(B, e.init, {
                                body: e.init
                            }));
                        r.push(s(B, e.condition, {
                            body: e.condition
                        }));
                        return s(O, e, {
                            body: r
                ...
                if (i instanceof fe)
                    if (o(i.body)) {
                        if (n.condition)
                            ...
                            n.condition = i.condition.negate(t);
                        a(i.alternative)
        ...
        e(fe, function(e, n) {
            ...
            if (U(e.alternative) && e.body instanceof B) {
                if (a === u && !f && e.condition instanceof Me && "||" == e.condition.operator)
                    f = !0;
                if (f)
                    return s(B, e, {
                        body: s(Me, e, {
            ...
            if (e.body instanceof ie && e.alternative instanceof ie && e.body.TYPE == e.alternative.TYPE)
        ...
        e(ce, function(e, n) {
            ...
            if (!n.option("dead_code"))
                return e;
            if (i instanceof w)
                i = e.expression.tail_node().evaluate(n);
            var o = [];
            var a = [];
            var u;
            var f;
            for (var c = 0, l = e.body.length; c < l && !f; c++) {
                if ((t = e.body[c])instanceof pe)
                    ...
                    if (g instanceof w)
                        g = t.expression.tail_node().evaluate(n);
                    if (g === i) {
                        f = t;
                        if (u) {
                            var p = a.indexOf(u);
                ...
                if (Rn(t)) {
                    var d = a[a.length - 1];
                    if (Rn(d) && d.body.length == t.body.length && s(O, d, d).equivalent_to(s(O, t, t)))
                        d.body = []
                }
                a.push(t)
            }
            for (; c < l; )
                b(e.body[c++], a[a.length - 1]);
            if (a.length > 0)
                a[0].body = o.concat(a[0].body);
            e.body = a;
            for (; t = a[a.length - 1]; ) {
                var h = t.body[t.body.length - 1];
                if (h instanceof se && n.loopcontrol_target(h) === e)
                    t.body.pop();
                if (t.body.length || t instanceof de && (u || t.expression.has_side_effects(n)))
                    break;
                if (a.pop() === u)
                    u = null
            }
            if (0 == a.length)
                return s(O, e, {
                    body: o.concat(s(B, e.expression, {
                        body: e.expression
                    }))
                }).optimize(n);
            if (1 == a.length && (a[0] === f || a[0] === u)) {
                ...
                var m = new $n(function(n) {
                    if (v || n instanceof J || n instanceof B)
                        return !0;
                    if (n instanceof se && m.loopcontrol_target(n) === e)
                        v = !0
                }
                );
                e.walk(m);
        ...
        e(he, function(e, n) {
            fn(e.body, n);
            if (e.bcatch && e.bfinally && g(e.bfinally.body, U))
                e.bfinally = null;
        ...
        e(we, function(e, t) {
            ...
            if (t.option("reduce_vars") && r instanceof pn)
                r = r.fixed_value();
                ...
                for (var c = 0, l = e.args.length; c < l; c++) {
                    if (r.argnames[c]instanceof Y) {
                        if (r.argnames[c].expression.__unused) {
                            for (; c < l; )
                                if (E = e.args[c++].drop_side_effect_free(t))
                                    e.args[u++] = E
                        } else
                            for (; c < l; )
                                e.args[u++] = e.args[c++];
            ...
            if (t.option("unsafe"))
                if (Xe(i))
                    ...
                    case "RegExp":
                        var d = [];
                        if (g(e.args, function(e) {
                            var n = e.evaluate(t);
                            d.unshift(n);
                            return e !== n
                        }))
                            try {
                                return qn(t, e, s(yn, e, {
                                    value: RegExp.apply(RegExp, d)
                                }))
                            } catch (n) {
                    ...
                    case "join":
                        if (i.expression instanceof Ne)
                            e: {
                                var v;
                                if (e.args.length > 0)
                                    if ((v = e.args[0].evaluate(t)) === e.args[0])
                                        break e;
                                var m = [];
                                var D = [];
                                for (c = 0,
                                l = i.expression.elements.length; c < l; c++) {
                                ...
                                if ("" == v) {
                                    var y;
                                    if (m[0].is_string(t) || m[1].is_string(t))
                                        y = m.shift();
                                    else
                                        y = s(gn, e, {
                                            value: ""
            ...
            if (t.option("unsafe_Function") && Xe(i) && "Function" == i.name) {
                ...
                if (g(e.args, function(e) {
                    ...
                    try {
                        var C = vt($ = "n(function(" + e.args.slice(0, -1).map(function(e) {
                            return e.value
                        ...
                        e.args = [s(gn, e, {
                            value: T.argnames.map(function(e) {
            ...
            if (a && !r.is_generator && !r.async) {
                var j, N, H, I, R = -1;
                if (t.option("inline") && o && !r.uses_arguments && !r.uses_eval && !(r.name && r instanceof X) && (N = function(e) {
                    ...
                    for (var o = 0; o < i; o++) {
                        var a = n[o];
                        if (a instanceof De) {
                            if (e && !g(a.definitions, function(e) {
                                return !e.value
                            }))
                                return !1
                        } else if (e)
                    ...
                    return Z(e)
                }(M)) && (i === r || t.option("unused") && 1 == (j = i.definition()).references.length && !Pn(t, j) && r.is_constant_expression(i.scope)) && !e.pure && !r.contains_this() && function() {
                    var e = Object.create(null);
                    do {
                        if ((H = t.parent(++R))instanceof ve)
                            e[H.argname.name] = !0;
                        else if (H instanceof z)
                            I = [];
                        else if (H instanceof pn)
                            if (H.fixed_value()instanceof L)
                                return !1
                    ...
                    return h(e, function() {
                        ...
                        if (n.length) {
                            ...
                            H.body.splice(c, 0, s(De, r, {
                                definitions: n
                            }))
                        }
                        return i
                    }()).optimize(t);
                if (t.option("side_effects") && !(r.body instanceof w) && g(r.body, U)) {
        ...
        e(Oe, function(e, n) {
            var t = e.expression;
            if ("delete" == e.operator && !(t instanceof pn || t instanceof ke || sn(t))) {
                if (t instanceof Ce) {
            ...
            if (n.option("side_effects") && "void" == e.operator)
                if (t = t.drop_side_effect_free(n)) {
                    ...
                    return s(wn, e).optimize(n);
            if (n.in_boolean_context())
                switch (e.operator) {
                case "!":
                    if (t instanceof Oe && "!" == t.operator)
                        return t.expression;
                    if (t instanceof Me)
                        e = qn(n, e, t.negate(n, E(n)));
                    break;
                case "typeof":
                    n.warn("Boolean expression always true [{file}:{line},{col}]", e.start);
                    return (t instanceof pn ? s(Sn, e) : h(e, [t, s(Sn, e)])).optimize(n)
                }
            if ("-" == e.operator && t instanceof Cn)
                t = t.transform(n);
            if (t instanceof Me && ("+" == e.operator || "-" == e.operator) && ("*" == t.operator || "/" == t.operator || "%" == t.operator))
                return s(Me, e, {
                    operator: t.operator,
                    left: s(Oe, t.left, {
                        operator: e.operator,
            ...
            if ("-" != e.operator || !(t instanceof bn || t instanceof Cn)) {
                var r = e.evaluate(n);
                if (r !== e)
                    return qn(n, r = _(r, e).optimize(n), e)
            }
            return e
        });
        ...
        e(Me, function(e, n) {
            function t() {
                return e.left.is_constant() || e.right.is_constant() || !e.left.has_side_effects(n) && !e.right.has_side_effects(n)
            }
            function i(n) {
                if (t()) {
                    if (n)
            ...
            if (n.option("comparisons"))
                ...
                case "===":
                case "!==":
                    if (e.left.is_string(n) && e.right.is_string(n) || e.left.is_number(n) && e.right.is_number(n) || e.left.is_boolean() && e.right.is_boolean() || e.left.equivalent_to(e.right))
                        e.operator = e.operator.substr(0, 2);
                case "==":
                case "!=":
                    if (n.option("typeofs") && e.left instanceof gn && "undefined" == e.left.value && e.right instanceof Oe && "typeof" == e.right.operator) {
                        var r = e.right.expression;
                        if (r instanceof pn ? r.is_declared(n) : !(r instanceof ke && n.option("ie8"))) {
                            e.right = r;
                            e.left = s(wn, e.left).optimize(n);
                            if (2 == e.operator.length)
                                e.operator += "="
                        }
                    } else if (e.left instanceof pn && e.right instanceof pn && e.left.definition() === e.right.definition() && ((o = e.left.fixed_value())instanceof Ne || o instanceof J || o instanceof He || o instanceof Ve))
            ...
            if ("+" == e.operator) {
                if (e.right instanceof gn && "" == e.right.getValue() && e.left.is_string(n))
                    return e.left;
                if (e.left instanceof gn && "" == e.left.getValue() && e.right.is_string(n))
                    return e.right;
                if (e.left instanceof Me && "+" == e.left.operator && e.left.left instanceof gn && "" == e.left.left.getValue() && e.right.is_string(n)) {
                    e.left = e.left.right;
            ...
            if (n.option("evaluate")) {
                switch (e.operator) {
                case "&&":
                    if (!(a = e.left.truthy ? !0 : e.left.falsy ? !1 : e.left.evaluate(n))) {
                        n.warn("Condition left of && always false [{file}:{line},{col}]", e.start);
                        return A(n.parent(), n.self(), e.left).optimize(n)
                    } else if (!(a instanceof w)) {
                        n.warn("Condition left of && always true [{file}:{line},{col}]", e.start);
                    ...
                    if (!(u = e.right.evaluate(n)))
                        ...
                        if ("&&" == (c = n.parent()).operator && c.left === n.self() || n.in_boolean_context()) {
                            n.warn("Dropping side-effect-free && [{file}:{line},{col}]", e.start);
                ...
                switch (e.operator) {
                case "+":
                    if (e.left instanceof Dn && e.right instanceof Me && "+" == e.right.operator && e.right.left instanceof Dn && e.right.is_string(n))
                        e = s(Me, e, {
                            operator: "+",
                            left: s(gn, e.left, {
                    ...
                    if (e.right instanceof Dn && e.left instanceof Me && "+" == e.left.operator && e.left.right instanceof Dn && e.left.is_string(n))
                        e = s(Me, e, {
                            operator: "+",
                            left: e.left.left,
                            right: s(gn, e.right, {
                    ...
                    if (e.left instanceof Me && "+" == e.left.operator && e.left.is_string(n) && e.left.right instanceof Dn && e.right instanceof Me && "+" == e.right.operator && e.right.left instanceof Dn && e.right.is_string(n))
                        e = s(Me, e, {
                            operator: "+",
                            left: s(Me, e.left, {
                                operator: "+",
                    ...
                    if (e.right instanceof Oe && "-" == e.right.operator && e.left.is_number(n)) {
                        e = s(Me, e, {
                            operator: "-",
                            left: e.left,
                    ...
                    if (e.left instanceof Oe && "-" == e.left.operator && t() && e.right.is_number(n)) {
                        e = s(Me, e, {
                            operator: "-",
                            left: e.right,
                ...
                case "|":
                case "^":
                    if (e.left.is_number(n) && e.right.is_number(n) && t() && !(e.left instanceof Me && e.left.operator != e.operator && dt[e.left.operator] >= dt[e.operator])) {
                        var d = s(Me, e, {
                            operator: e.operator,
                            left: e.right,
                            right: e.left
                    ...
                    if (p && e.is_number(n)) {
                        ...
                        if (e.right instanceof Dn && e.left instanceof Me && e.left.operator == e.operator)
                        ...
                        if (e.left instanceof Me && e.left.operator == e.operator && e.left.right instanceof Dn && e.right instanceof Me && e.right.operator == e.operator && e.right.left instanceof Dn)
                            e = s(Me, e, {
                                operator: e.operator,
                                left: s(Me, e.left, {
                                    operator: e.operator,
            ...
            if (e.right instanceof Me && e.right.operator == e.operator && (vn(e.operator) || "+" == e.operator && (e.right.left.is_string(n) || e.left.is_string(n) && e.right.right.is_string(n)))) {
                e.left = s(Me, e.left, {
                    operator: e.operator,
                    left: e.left,
                    right: e.right.left
        ...
        e(pn, function(e, t) {
            ...
            if (i)
                return i.optimize(t);
            if (!t.option("ie8") && Xe(e) && (!e.scope.uses_with || !t.find_parent(P)))
                switch (e.name) {
                case "undefined":
                    return s(wn, e).optimize(t);
                case "NaN":
            ...
            if (t.option("reduce_vars") && En(e, t.parent()) !== e) {
                ...
                if (a && (o instanceof J || o instanceof Ve))
                    if (r.scope !== e.scope && (!t.option("reduce_funcs") && o instanceof J || 1 == r.escaped || o.inlined))
                        a = !1;
                    else if (Pn(t, r))
                        a = !1;
                ...
                if (o && void 0 === r.should_replace) {
                    var d;
                    if (o instanceof mn) {
                        if (!(r.orig[0]instanceof nn) && g(r.references, function(e) {
                            return r.scope === e.scope
                        }))
                            d = o
                    } else {
                        var h = o.evaluate(t);
                        if (h !== o && (t.option("unsafe_regexp") || !(h instanceof RegExp)))
                            d = _(h, o)
                    }
                    if (d) {
        ...
        function Vn(e, n) {
            ...
            var r = new $n(function(e) {
                if (i)
                    return !0;
                if (e instanceof pn && t(e.definition(), n))
                    return i = !0
            }
            );
            var o = new $n(function(n) {
                ...
                if (n instanceof L && n !== e) {
                    var t = o.parent();
                    if (t instanceof we && t.expression === n)
                        return;
                    n.walk(r);
                    return !0
                }
        ...
        e(ze, function(e, n) {
            var i;
            if (n.option("dead_code") && e.left instanceof pn && (i = e.left.definition()).scope === n.find_parent(J)) {
                var r, o = 0, a = e;
                do {
                    r = a;
                    if ((a = n.parent(o++))instanceof ie) {
                        if (u(o, a instanceof oe))
                            break;
                        if (Vn(i.scope, [i]))
                            break;
                        if ("=" == e.operator)
                ...
                } while (a instanceof Me && a.right === r || a instanceof Ce && a.tail_node() === r)
            }
            if ("=" == (e = e.lift_sequences(n)).operator && e.left instanceof pn && e.right instanceof Me)
                if (e.right.left instanceof pn && e.right.left.name == e.left.name && t(e.right.operator, Yn)) {
                    e.operator = e.right.operator + "=";
                    e.right = e.right.right
                } else if (e.right.right instanceof pn && e.right.right.name == e.left.name && t(e.right.operator, Jn) && !e.right.left.has_side_effects(n)) {
                    e.operator = e.right.operator + "=";
        ...
        e(qe, function(e, n) {
            ...
            var a = e.consequent;
            var u = e.alternative;
            if (o instanceof pn && a instanceof pn && o.definition() === a.definition())
                return s(Me, e, {
                    operator: "||",
                    left: o,
                    right: u
                });
            if (a instanceof ze && u instanceof ze && a.operator == u.operator && a.left.equivalent_to(u.left) && (!e.condition.has_side_effects(n) || "=" == a.operator && !a.left.has_side_effects(n)))
                return s(ze, e, {
                    operator: a.operator,
                    left: a.left,
                    right: s(qe, e, {
            ...
            var f;
            if (a instanceof we && u.TYPE === a.TYPE && a.args.length > 0 && a.args.length == u.args.length && a.expression.equivalent_to(u.expression) && !e.condition.has_side_effects(n) && !a.expression.has_side_effects(n) && "number" == typeof (f = function() {
                var e = a.args;
                var n = u.args;
                for (var t = 0, i = e.length; t < i; t++) {
                    if (e[t]instanceof Y)
            ...
            if (a.equivalent_to(u))
                return h(e, [e.condition, a]).optimize(n);
            ...
            function d(e) {
                return e instanceof Sn || l && e instanceof Dn && e.getValue() || e instanceof Oe && "!" == e.operator && e.expression instanceof Dn && !e.expression.getValue()
            }
            function v(e) {
                return e instanceof Bn || l && e instanceof Dn && !e.getValue() || e instanceof Oe && "!" == e.operator && e.expression instanceof Dn && e.expression.getValue()
            }
        });
        e(kn, function(e, n) {
            if (n.in_boolean_context())
        ...
        e(Se, function(e, n) {
            ...
            if (n.option("properties")) {
                ...
                if (r !== i) {
                    if ("string" == typeof r)
                        if ("undefined" == r)
                            r = void 0;
                        else if ((v = parseFloat(r)).toString() == r)
                            r = v;
            ...
            if (n.option("properties") && n.option("side_effects") && i instanceof bn && t instanceof Ne) {
                var u = i.getValue();
                var f = t.elements;
                e: if (u in f) {
                    var c = !0;
                    ...
                    for (; --p >= 0; ) {
                        var v;
                        if ((v = f[p])instanceof Y)
                            break e;
                        if (v = v.drop_side_effect_free(n))
                            l.unshift(v);
                        else
                            u--
                    }
            ...
            var m = e.evaluate(n);
            if (m !== e)
                return qn(n, m = _(m, e).optimize(n), e);
            return e
        });
        J.DEFMETHOD("contains_this", function() {
            var e;
            var n = this;
            n.walk(new $n(function(t) {
                if (e)
                    return !0;
                if (t instanceof mn)
                    return e = !0;
                if (t !== n && t instanceof L && !(t instanceof G))
                    return !0
            }
            ));
            return e
            ...
            if (i instanceof He) {
                ...
                for (var o = r.length; --o >= 0; ) {
                    ...
                    if ("" + (a instanceof Le ? a.key.name : a.key) == e) {
                        if (!g(r, function(e) {
                            return e instanceof Re || t && e instanceof Le && !e.is_generator
                        }))
                            break;
                        var u = a.value;
                        if ((u instanceof W || u instanceof X) && !(n.parent()instanceof xe) && u.contains_this())
                            break;
                        return s(Se, this, {
                            expression: s(Ne, i, {
                                elements: r.map(function(e) {
                                    ...
                                    if (n instanceof W)
                                        n = s(X, n, n);
                                    var t = e.key;
                                    if (t instanceof w && !(t instanceof rn))
                                        return h(e, [t, n]);
                                    return n
                                })
                            }),
        ...
        e(Be, function(e, n) {
            ...
            if (En(e, n.parent()))
                return e;
            if (n.option("unsafe_proto") && e.expression instanceof Be && "prototype" == e.expression.property) {
                var i = e.expression.expression;
                if (Xe(i))
                    switch (i.name) {
                    case "Array":
                        e.expression = s(Ne, e.expression, {
                            elements: []
                        });
                        break;
                    case "Function":
                        e.expression = s(X, e.expression, {
                            argnames: [],
                            body: []
                        });
                        break;
                    case "Number":
                        e.expression = s(bn, e.expression, {
                            value: 0
                        });
                        break;
                    case "Object":
                        e.expression = s(He, e.expression, {
                            properties: []
                        });
                        break;
                    case "RegExp":
                        e.expression = s(yn, e.expression, {
                            value: /t/
                        });
                        break;
                    case "String":
                        e.expression = s(gn, e.expression, {
                            value: ""
                        })
                    }
            }
            ...
            var o = e.evaluate(n);
            if (o !== e)
                return qn(n, o = _(o, e).optimize(n), e);
            return e
        });
        function Wn(e, n) {
            if (n.in_boolean_context())
        ...
        e(X, function(e, n) {
            fn(e.body, n);
            if (n.option("unsafe_arrows") && n.option("ecma") >= 6 && !e.name && !e.is_generator && !e.uses_arguments && !e.uses_eval) {
                var t = !1;
                e.walk(new $n(function(e) {
                    if (t)
                        return !0;
        ...
        e(Fe, function(e, n) {
            ...
            if (t && y(t, e.name.name))
                n.warn("global_defs " + e.name.name + " redefined [{file}:{line},{col}]", e.start);
            return e
        });
        e(ee, function(e, n) {
            if (!n.option("evaluate") || n.parent()instanceof Q)
                return e;
            var t = [];
            for (var i = 0; i < e.segments.length; i++) {
                var r = e.segments[i];
                if (r instanceof w) {
                    ...
                    if (o !== r && (o + "").length <= r.print_to_string().length + 3) {
                        t[t.length - 1].value = t[t.length - 1].value + o + e.segments[++i].value;
                        continue
                    }
                }
                t.push(r)
        ...
        function Xn(e, n) {
            if (!n.option("computed_props"))
                return e;
            if (!(e.key instanceof Dn))
                return e;
            if (e.key instanceof gn || e.key instanceof bn) {
                if ("constructor" == e.key.value && n.parent()instanceof Ve)
                    return e;
                if (e instanceof Re)
                    e.key = e.key.value;
                else
        ...
        e(Le, function(e, n) {
            Xn(e, n);
            if (n.option("arrows") && n.parent()instanceof He && !e.value.uses_arguments && !e.value.uses_eval && 1 == e.value.body.length && e.value.body[0]instanceof re && e.value.body[0].value && !e.value.contains_this()) {
        ...
        e(Re, function(e, n) {
            ...
            if (t && n.option("ecma") >= 6 && (!(t instanceof RegExp) || t.test(e.key + ""))) {
                var i = e.key;
                var r = e.value;
                if ((r instanceof G && Array.isArray(r.body) && !r.contains_this() || r instanceof X) && !r.name)
                    return s(Le, e, {
                        async: r.async,
                        is_generator: r.is_generator,
                        key: i instanceof w ? i : s(rn, e, {
                            name: i
                        }),
                        value: s(W, r, r),
                        quote: e.quote
    ...
    !function() {
        var n = function(e) {
            ...
            for (var t = 0; t < e.length; t++)
                ...
                else if (n && !(e[t]instanceof x && e[t].body instanceof gn))
                    n = !1;
            return e
        };
        var t = {
            ...
            Literal: function(e) {
                ...
                default:
                    var i = e.regex;
                    if (i && i.pattern)
                        t.value = RegExp(i.pattern, i.flags).toString();
                    else
                        t.value = e.regex && e.raw ? e.raw : n;
                    return new yn(t)
                }
            },
            Identifier: function(e) {
                var n = s[s.length - 2];
                return new ("LabeledStatement" == n.type ? ln : "VariableDeclarator" == n.type && n.id === e ? "const" == n.kind ? Qe : Ze : "FunctionExpression" == n.type ? n.id === e ? on : nn : "FunctionDeclaration" == n.type ? n.id === e ? tn : nn : "CatchClause" == n.type ? un : "BreakStatement" == n.type || "ContinueStatement" == n.type ? vn : pn)({
                    start: r(e),
                    end: o(e),
                    name: e.name
                })
        ...
        t.UpdateExpression = t.UnaryExpression = function(e) {
            return new (("prefix"in e ? e.prefix : "UnaryExpression" == e.type ? 1 : 0) ? Oe : $e)({
                start: r(e),
                end: o(e),
                operator: e.operator,
        ...
        a("IfStatement", fe, "test>condition, consequent>body, alternate>alternative");
        ...
        a("ConditionalExpression", qe, "test>condition, consequent>consequent, alternate>alternative");
        ...
        function a(n, i, a) {
            ...
            if (a)
                a.split(/\s*,\s*/).forEach(function(e) {
                    ...
                    if (!n)
                        throw Error("Can't understand property map: " + e);
                    var t = n[1]
                      , i = n[2]
                      , r = n[3];
                    s += ",\n" + r + ": ";
            ...
            d = Function("to_moz", "to_moz_block", "to_moz_scope", "return(" + d + ")")(c, l, p);
            t[n] = s;
            f(i, d)
        }
        var s = null;
        ...
        function f(e, n) {
            e.DEFMETHOD("to_mozilla_ast", function() {
                return function(e, n, t) {
                    var i = e.start;
                    var r = e.end;
                    if (null != i.pos && null != r.endpos)
                        n.range = [i.pos, r.endpos];
                    if (i.line) {
                        n.loc = {
                            start: {
                                line: i.line,
    ...
    var wt = "undefined" == typeof atob ? function(e) {
        return new Buffer(e,"base64").toString()
    }
    : atob;
    var xt = "undefined" == typeof btoa ? function(e) {
        return new Buffer(e).toString("base64")
    }
    : btoa;
    function Ct(e) {
        var n = /\n\/\/# sourceMappingURL=data:application\/json(;.*?)?;base64,(.*)/.exec(e);
        if (!n) {
    ...
    function Bt(e) {
        ...
        if (!("props"in e))
            e.props = new b;
        else if (!(e.props instanceof b))
            e.props = b.fromObject(e.props)
    }
    function St(e) {
        return {
    ...
    e.minify = function(e, n) {
        ...
        try {
            ...
            if (void 0 === n.keep_classnames)
                n.keep_classnames = n.keep_fnames;
            if (void 0 === n.rename)
                n.rename = n.compress && n.mangle;
            ...
            if (n.mangle) {
                ...
                if (n.mangle.properties) {
                    if ("object" != typeof n.mangle.properties)
                        n.mangle.properties = {};
            ...
            if (r)
                !function(e, n) {
                    ...
                    s.walk(new $n(function(e) {
                        if (e instanceof Re && e.quote)
                            t(e.key);
                        else if (e instanceof Ie && e.quote)
                            t(e.key.name);
            ...
            if (i)
                i.compress = Date.now();
            if (n.compress)
                s = new At(n.compress).compress(s);
            if (i)
                i.scope = Date.now();
            if (n.mangle)
                s.figure_out_scope(n.mangle);
                ...
                s = function(e, n) {
                    ...
                    if (!n.builtins)
                        !function(e) {
                            ...
                            ["null", "true", "false", "Infinity", "-Infinity", "undefined"].forEach(i);
                    ...
                    return e.transform(new mt(function(e) {
                        if (e instanceof Re)
                            e.key = v(e.key);
                        else if (e instanceof Ie)
                            e.key.name = v(e.key.name);
                        else if (e instanceof Be)
                            e.property = v(e.property);
                        else if (!n.keep_quoted && e instanceof Se)
                            e.property = function e(n) {
                                return n.transform(new mt(function(n) {
                                    if (n instanceof Ce) {
            ...
            if (!y(n.output, "code") || n.output.code) {
                ...
                if (n.sourceMap) {
                    ...
                    if ("inline" == n.sourceMap.url)
                        f.code += "\n//# sourceMappingURL=data:application/json;charset=utf-8;base64," + xt(f.map);
            ...
            if (n.nameCache && n.mangle) {
                if (n.mangle.cache)
                    n.nameCache.vars = St(n.mangle.cache);
            ...
            if (i) {
                i.end = Date.now();
                f.timings = {
                    parse: .001 * (i.rename - i.parse),
                    rename: .001 * (i.compress - i.rename),
                    compress: .001 * (i.scope - i.compress),
                    scope: .001 * (i.mangle - i.scope),
                    mangle: .001 * (i.properties - i.mangle),
                    properties: .001 * (i.output - i.properties),
                    output: .001 * (i.end - i.output),
                    total: .001 * (i.end - i.start)
                }
            }
            if (o.length)
                f.warnings = o;
